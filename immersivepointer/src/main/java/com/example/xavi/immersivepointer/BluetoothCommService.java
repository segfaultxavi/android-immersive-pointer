...
public class BluetoothCommService {
    ...
    private static final String NAME_SECURE = "BluetoothComm";
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(MESSAGE_READ, -1, -1,
                            ByteBuffer.wrap(buffer, 0, bytes).order(ByteOrder.LITTLE_ENDIAN))
                            .sendToTarget();
                } catch (IOException e) {
